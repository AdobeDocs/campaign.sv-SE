...
# Kom igång med transaktionsmeddelanden{#send-transactional-messages}
...
[!DNL :bulb:] Inställningar för transaktionsmeddelanden beskrivs i  [det här avsnittet](../config/transactional-msg-settings.md).
