...
[!DNL :bulb:] Mer information finns i  [Utöka ett schema](extend-schema.md).
...
[!DNL :bulb:] Mer information finns i  [Skapa ett nytt schema](create-schema.md).
...
[!DNL :bulb:] Läs mer om tangenter i  [det här avsnittet](database-mapping.md#management-of-keys).
