...
* **[Filtrera data](../audiences/create-filters.md)** - Upptäck befintliga inbyggda filter för att komma åt en viss delmängd av Campaign-data, för att skapa snabbfilter eller för att utforma och dela egna avancerade filter.