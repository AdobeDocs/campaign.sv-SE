...
* Filen setup-client.exe har ersatts med en ac-client.msi-fil. Detta är ett enklare sätt för administratörer att utföra massuppgraderingar utan att användaren behöver göra något.
