...
Se versionsinformationen [för Campaign Web-gränssnittet](https://experienceleague.adobe.com/docs/campaign-web/v8/release-notes/release-notes.html){target="_blank"}.
