...
Utöver funktionerna som listas ovan innehåller den här versionen även en uppsättning funktioner som är tillgängliga i användargränssnittet Campaign på webben:
...
* [Dynamisk rapportering](https://experienceleague.adobe.com/docs/campaign-web/v8/reports/dynamic-reporting/get-started-reporting.html){target="_blank"} (endast på begäran)
* [Centraliserad profilering](https://experienceleague.adobe.com/docs/campaign-web/v8/conf/branding/branding-gs.html){target="_blank"}

Se versionsinformationen [för Campaign Web-gränssnittet](https://experienceleague.adobe.com/docs/campaign-web/v8/release-notes/release-notes.html?lang=sv-SE){target="_blank"}.
...
* Tillhandahöll en tyst installationsmekanism för klientkonsolen för att underlätta massuppgraderingar utan att användaren behöver göra något. Detta löser problem med manuella installationer. (NEO-69772)
...
* Ett problem med tidszonsavvikelser i Ryssland (UTC+3:00 i Moskva) där `nlserver` utdatatider var felaktiga har åtgärdats. Tidssynkroniseringslogiken har uppdaterats. (NEO-74754)
