...
[&#128279;](../assets/do-not-localize/book.png) Lär dig hur du konfigurerar och använder Campaign Response Manager i [Campaign Classic v7-dokumentationen](https://experienceleague.adobe.com/docs/campaign-classic/using/response-manager/about-response-manager.html?lang=sv-SE){target="_blank"}.
