...
**Obs!** Om du behöver lokal eller hybriddistribution är Campaign Classic v7 fortfarande tillgängligt med fullständigt stöd.
...
Läs mer om [övervakning av leveranser](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/monitoring-deliveries/about-delivery-monitoring.html?lang=sv-SE){target="_blank"} och [bästa sättet att leverera](../send/delivery-best-practices.md).
...
* **Arbetsflödesloggar** - Använd detaljerade körningsloggar för att felsöka problem
* **Heatmap** - Visualisera arbetsflödesaktivitet och identifiera flaskhalsar i prestandan
* **[Granskningsspår](../reporting/audit-trail.md)** - Spåra alla ändringar som gjorts i arbetsflöden
* **Varningar** - Konfigurera meddelanden om arbetsflödesfel eller fördröjningar
