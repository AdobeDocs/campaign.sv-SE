...
Få svar på de vanligaste frågorna om Adobe Campaign v8, inklusive hur du ansluter, kommer igång och får tillgång till support.
...
[Bildskärmsleveranser](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/monitoring-deliveries/about-delivery-monitoring.html?lang=sv-SE){target="_blank"} | [Bästa tillvägagångssätt vid leverans](delivery-best-practices.md)
...
Med landningssidor i Campaign kan ni samla in leads, hantera prenumerationer och samla in data via webbformulär. Det finns två metoder i Campaign: **Klientkonsolen** för avancerade formulär med komplex logik och **Webbgränssnittet för Campaign** för snabb, modern framtagning av landningssidor med en dra-och-släpp-redigerare.

**Webbgränssnitt för kampanj (rekommenderas för de flesta användare):**

* Använd den visuella redigeraren för att utforma responsiva landningssidor
* Lägg till formulärfält, bilder och innehållsblock med dra-och-släpp
* Koppla formulärfält till databasattribut
* Konfigurera förifyllda meddelanden, bekräftelsemeddelanden och tacksidor
* Publicera och spåra material i realtid

**Klientkonsol (för avancerad användning):**

* Bygg skräddarsydda webbapplikationer med komplex affärslogik
* Definiera avancerade fältmappnings- och valideringsregler
* Skapa flersidiga formulär med villkorlig dirigering
* Få tillgång till den fullständiga Campaign-datamodellen för berikning

**Relaterade ämnen:**

[Skapa landningssidor (webbgränssnitt)](https://experienceleague.adobe.com/sv/docs/campaign-web/v8/landing-pages/get-started-lp){target="_blank"} | [Webbprogram (klientkonsol) &#x200B;](../dev/landing-pages.md)
