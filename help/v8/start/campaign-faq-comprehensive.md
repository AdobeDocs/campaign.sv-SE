...
Campaign v8 är en Adobe-plattform, idealisk för organisationer som behöver kampanjer i stora volymer (20 MB drift/timme), modernt webbgränssnitt, molnbaserade fördelar och långsiktig support.
...
[Från Campaign Classic v7 till v8](v7-to-v8.md) | [Campaign Standard övergångsguide](https://experienceleague.adobe.com/sv/docs/campaign-web/v8/start/acs-migration){target="_blank"} | [Funktionsmatris](https://experienceleague.adobe.com/sv/docs/campaign-web/v8/start/capability-matrix){target="_blank"}
...
[Funktionsmatris](https://experienceleague.adobe.com/sv/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [&#x200B; Övergångshandbok för v7 till v8 &#x200B;](v7-to-v8.md) | [Övergång mellan Campaign Standard och v8](https://experienceleague.adobe.com/sv/docs/campaign-web/v8/start/acs-migration){target="_blank"}
...
Läs mer i guiden [Avsändningsadresser](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/action-activities/delivery-control.html?lang=sv-SE){target="_blank"}
...
Läs mer i [Typologiregelguiden](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=sv-SE){target="_blank"}
...
[Schemaläggaraktivitet](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/scheduler.html?lang=sv-SE){target="_blank"} | [Återkommande leveranser](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/sending-a-birthday-email.html){target="_blank"} | [Kampanjautomatisering](https://experienceleague.adobe.com/docs/campaign/automation/home.html?lang=sv-SE){target="_blank"}
...
[Personalization-guide](../send/personalize.md) | [Användningsexempel för arbetsflöden](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/send-a-birthday-email.html?lang=sv-SE){target="_blank"}
...
[Målaktiviteter](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/targeting-activities.html?lang=sv-SE){target="_blank"} | [&#x200B; Flödeskontroll &#x200B;](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/flow-control-activities/flow-control-activities.html?lang=sv-SE){target="_blank"} | [Åtgärdsaktiviteter](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/action-activities/action-activities.html?lang=sv-SE){target="_blank"}
...
[Handbok om arbetsflöden för bästa praxis](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=sv-SE){target="_blank"} | [Övervaka arbetsflöden](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/monitor-workflow-execution.html?lang=sv-SE){target="_blank"}
...
+++ Hur kontrollerar jag att mina operatorer och behörigheter följer god säkerhetspraxis?

Adobe Campaign v8 erbjuder möjlighet att jämföra alla aktuella inställningar för konton på den högsta nivån och behöriga konton med rekommenderade säkra standardinställningar.

* **Aktuella inställningar (fullständig synlighet):** Alla inställningar för administrativa och privilegierade konton kan granskas i **[!UICONTROL Administration]** > **[!UICONTROL Access management]** (klientkonsolen eller webbgränssnittet för kampanj): **[!UICONTROL Operators]**, **[!UICONTROL Operator groups]**, **[!UICONTROL Named rights]** (t.ex. ADMINISTRATION, GODKÄNNANDEADMINISTRATION) och behörigheter på mappnivå. Produktadministratörer kan också granska instansnivåinställningar på [Campaign-kontrollpanelen](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html?lang=sv){target="_blank"} (IP-tillåtelselista, URL-behörigheter, instansinformation med mera).
* **Rekommenderade säkra standardvärden:** [Säkerhetsriktlinjerna](../config/security.md) definierar den rekommenderade säkra baslinjen för administrativa och privilegierade konton, inklusive: skapa tillräckliga säkerhetsgrupper, tilldela lämpliga åtkomsträttigheter per operator och begränsa användningen av administratörsoperatorn och administratörsgruppen. Om tillämpligt, se även [Förbättrat säkerhetstillägg](../config/enhanced-security.md) för nätverks- och krypteringsskydd.
* **Jämförelse:** Administratörer jämför sin nuvarande konfiguration med dessa dokumenterade rekommendationer för att identifiera luckor och anpassa den till säkra standardinställningar.

**Relaterade ämnen:**

[Kom igång med behörigheter](gs-permissions.md) | [Riktlinjer för säkerhet](../config/security.md) | [Förbättrat säkerhetstillägg](../config/enhanced-security.md)
...
Campaign v8 ger FDA (Federated Data Access) möjlighet att söka efter och använda data som lagras i externa databaser utan att ändra Campaigns datamodell. Ni konfigurerar ett externt konto och använder sedan FDA i arbetsflöden, frågor och målinriktning för att kombinera externa data med Campaign-profiler.

Tillgänglighet och anslutningskrav för FDA beror på driftsättning och licensiering. Granska databaser som stöds och obligatoriska versioner i kompatibilitetsmatrisen.
...
**Om problemet kvarstår (avancerat):**

Stäng klientkonsolen och ta sedan bort de lokala cachefilerna manuellt från användarprofilen.

**Manuell cacherensning (Windows):**

1. Välj **[!UICONTROL File]** > **[!UICONTROL Clear the local cache...]** i klientkonsolen.
2. Logga ut och stäng klientkonsolen.
3. Gå till cacheplatsen baserat på din Windows-version. För Windows 10: `C:\Users\<Username>\AppData\Roaming\Neolane\NL_5\`
4. Ta bort filerna `nlclient-config-<alphanumerical>.xml` och tillhörande mappar.

>[!IMPORTANT]
>
>Ta inte bort `nlclient_cnx.xml`.

Adobe Support kan bekräfta rätt cacheplats för din version och operativsystem och vägleda dig genom en säker manuell rensning.

Läs mer i [Installera och konfigurera klientkonsolen](connect.md)

+++

+++ Kan Adobe Campaign integreras med LDAP?

Nej. Campaign v8 stöder inte LDAP-integrering. Autentisering använder Adobe IMS (Adobe ID eller Federated ID). Om du migrerar från Campaign Classic v7 kan du granska funktioner som inte stöds och autentiseringsändringar.

**Relaterade ämnen:**

[Anslut till kampanj v8](connect.md) | [Funktioner som inte stöds i v8](v7-to-v8.md#gs-removed)
...
[Frågeredigeraren](../start/query-editor.md) | [Frågeaktivitet](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/query.html?lang=sv-SE){target="_blank"}
