...
description: Rekommenderad vägledning för säker konfiguration för Campaign
feature: Privacy, PI
role: Developer
level: Beginner
...
* **Den här sidan** - [Bästa praxis för kampanjsäkerhet](#ac-security) (checklista och detaljerade avsnitt)
* **[Kampanjinställningar (Vanliga frågor och svar)](../start/campaign-faq-comprehensive.md#settings)** - Jämför inställningarna med rekommenderade säkra standardinställningar
* **[Utökat säkerhetstillägg](enhanced-security.md)** - Säker CMK-integrering och Säker VPN-tunnel
* **[Kom igång med behörigheter](../start/gs-permissions.md)** - Åtkomst och produktprofiler
* **[Begränsa PII-vyn](../dev/restrict-pi-view.md)** - Begränsa åtkomst till känsliga fält
* **[Riktlinjer för implementering](../start/implement.md)** - Säkerhet och sekretess innan du börjar
