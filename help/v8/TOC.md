...
# Adobe Campaign v8 (konsol) - dokumentation {#campaign-v8}
...
+ Versionsinformation {#releases}
   ...
   + [Skyddsräcken](start/ac-guardrails.md)
...
+ Skicka meddelanden {#send}
   ...
   + Anpassa innehåll {#personalize}
      ...
      + [Personaliserade kuponger](send/personalized-coupons.md)
      + [Skapa personaliserade PDF-dokument](send/generating-personalized-pdf-documents.md)
      + [Anpassa listan över uttryckssymboler](send/customizing-emoticon-list.md)
...
+ Profiler och målgrupper {#audience}
...
+ Landningssidor och Forms {#content}
...
+ Resurser för utvecklare {#developer}
   ...
   + Scheman och formulär {#schemas-forms}
   ...
   + [Fråga databasen med queryDef](dev/query-api.md)
   + REST API:er {#apis}
      ...
      + Hantera tjänster och prenumeration {#managing-services-and-subscriptions}
